...
| **图谱+规则**(结构化查询) | 94.8% | 92.2% | 100% | **95.9%** |

> 主集 F1 从 97.9% 降到 95.9% 是**刻意校准**：双联抗栓等从 critical 降为 high，减少假 critical。外部 holdout 精确匹配 73%→87%。
...
与主集对比：主集 95.9% 含 61 条自产样本；外部 holdout 在非自产分布上二分类全对，精确匹配 87%，剩余误差主要是 severity 边界（如 MTX+TMP 期望 critical、图谱 high）。
